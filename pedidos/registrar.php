...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Verificar que existan platillos en el POST
        if (!empty($_POST['platillos'])) {
...
<!-- Asegúrate de incluir jQuery y otros scripts necesarios -->
<script src="/restauranteBD/assets/js/jquery.min.js"></script>
<script src="/restauranteBD/assets/js/bootstrap.bundle.min.js"></script>
